...
public class PlayerController : MonoBehaviour
{
    ...
    private const string StopJump = "stopJump";
    ...
    private void Update()
    {
        ...
        movementVector += Physics.gravity * 0.8f;
    ...
    private void MovementJump()
    {
        ...
        if (_groundedPlayer)
        {
            ...
            _characterAnimator.SetBool(StopJump, true);
        }

        if (_isJumping && _groundedPlayer)
        {
            _playerVelocity.y += Mathf.Sqrt(_jumpHeight * -1f * GravityValue);
            _characterAnimator.SetBool(StopJump, false);
